...
var textArea = document.querySelector('#doc-view');
...
$(window).on('resize', function () {
  $('#doc-view').css('height', 'auto');
  $('#doc-view').height($('#doc-view').prop('scrollHeight'));
});
//calling this twice fixes an issue with height
$('#doc-view').height($('#doc-view').prop('scrollHeight'));
$('#doc-view').height($('#doc-view').prop('scrollHeight'));
